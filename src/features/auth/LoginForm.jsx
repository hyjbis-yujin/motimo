    ...
    <div className="w-full">
      <form onSubmit={handleLogin} className="flex flex-col gap-3">
        <input
          ...
          className="w-full h-[56px] px-4 rounded-banner bg-bg-subtle border border-border-subtle text-base outline-none focus:border-primary-mint transition-colors placeholder:text-[#bbbbbb]"
          value={email}
